...
namespace ApprovalTests
{
	public class Approvals
	{
		...
		public static void VerifyWithAdditionalFeedbackOnFailure(object text, Action<string> executeOnFailure)
		{
			Verify(new ExecutableLambda("" + text, executeOnFailure));
		}
		public static void VerifyWithAdditionalFeedbackOnFailure(object text, Func<string, string> executeOnFailure)
		{
			Verify(new ExecutableLambda("" + text, executeOnFailure));
		}
	}
