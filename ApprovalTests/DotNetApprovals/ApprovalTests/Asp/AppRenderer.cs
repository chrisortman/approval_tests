...
{
	public class AppRenderer : MarshalByRefObject
	{
		...
		public static AppRenderer GetHostRelativeToAssemblyPath(string relativePath)
		{
			string asmFilePath = new Uri(typeof(AppRenderer).Assembly.CodeBase).LocalPath;
		...
		public static AppRenderer GetHost(string webRootPath)
		{
			var host = (AppRenderer)ApplicationHost.CreateApplicationHost(
			                           	typeof(AppRenderer),
			                           	"/test",
			                           	webRootPath);
